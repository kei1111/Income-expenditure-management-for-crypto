...
export const WorkLeft: React.FC<{ progress: number; children: any }> = ({
  ...
  return (
    <div
      className="work-left flex flex-col items-center justify-center text-3xl lg:text-3xl h-[30vh] lg:h-auto"
      style={{
...
export const WorkRight: React.FC<{ progress: number; children: any }> = ({
  ...
  return (
    <div
      className="work-right flex flex-1 lg:items-center justify-center h-screen"
      style={{
        transform: `translateY(${translateY}px)`,
      }}
    >
