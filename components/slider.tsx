...
import { SizeContext } from "../utilis/size-observer";
import useAnimationFrame from "../utilis/use-animation-frame";
...
const SliderContainer: React.FC<Props> = ({
  ...
  return (
    <div
      ref={refContainer}
      className={`slider-container overflow-x-hidden whitespace-nowrap max-w-full pointer-events-none mt-6 ${className}`}
    >
