  ...
  return (
    <div className="main-container">
      ...
      <div className="headline_1">
        <h3>第1条 （規約）</h3>
        <p>
          「クリプトノート利用規約」（以下、「本規約」とします。）は、Aimi
          Takahashi（以下「提供者」）が提供するクリプトノート（以下、「本アプリ」とします。）の利用条件などを定めるものです。本アプリを利用する者（以下、「利用者」とします。）は、本規約に同意し、これを遵守しなければなりません。本規約に同意できない場合、本アプリのダウンロード、インストール及び使用を中止してください。本アプリをダウンロード、インストール又は使用する場合、利用者は、本規約に同意したものとします。
        </p>
      </div>
      ...
      <div className="headline_24">
        <h3>第24条 （情報管理）</h3>
        <p>
          クリプトノートでの記録はiOSデバイスのみに保存されます。ユーザーが入力した記録をサーバーに送信することはありません。
        </p>
      </div>
